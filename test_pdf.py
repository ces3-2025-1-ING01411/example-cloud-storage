...
# test_upload_file = test_cloud_storage.upload_file("pdf_cloud.pdf", file_to_upload)
# print(test_upload_file)

# #TODO: UPDATE
# new_file = os.path.join(ASSETS_DIR, "new_pdf.pdf")
# test_update_file = test_cloud_storage.update_file("pdf_cloud.pdf", new_file)
...
# #TODO: DELETE
# test_delete_file = test_cloud_storage.delete_file("pdf_cloud.pdf")
